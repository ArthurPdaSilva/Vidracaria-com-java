...
public class OuvintePlaceholder implements FocusListener{
    private JTextField item;
    private String nome;
    private JTextArea txtArea;
    
    public OuvintePlaceholder(JTextField item, String nome){
    ...
    public OuvintePlaceholder(JTextArea txtArea, String nome){
